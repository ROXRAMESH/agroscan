    ...
    <div class="page-content d-flex align-items-stretch">
      ...
      <nav class="side-navbar z-index-40">
        ...
        <ul class="list-unstyled py-4">
          ...
          <li class="sidebar-item active"><a class="sidebar-link" href="/tables">
              <svg class="svg-icon svg-icon-sm svg-icon-heavy me-xl-2">
                <use xlink:href="#portfolio-grid-1"> </use>
              </svg>Tables </a></li>
          <li class="sidebar-item"><a class="sidebar-link" href="/map1">
              <svg class="svg-icon svg-icon-sm svg-icon-heavy me-xl-2">
                  ...
                  <tbody>
                    ...
                    <tr>
                     ...
                     <th scope="row">{{1}}</th>
                      ...
                      <td>{{$tree_counts[$i]}}</td>
                      {{-- <td>@mdo</td> --}}
                      <td><button class="col-8 btn btn-primary" onclick="sendID();">Solution</button>
                      </td>
