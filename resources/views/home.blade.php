                        ...
                        <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end mt-3 shadow-sm" aria-labelledby="messages">
                                    <li>
                                        <a class="dropdown-item d-flex py-3" href="#"> <img class="img-fluid rounded-circle" src="{{ asset('img/avatar-1.jpg')}}" alt="..." width="45">
                                    ...
                                    <li>
                                        <a class="dropdown-item text-center" href="#"> <strong class="text-xs text-gray-600">Read all
                                                messages </strong></a>
                                    </li>
                                </ul>
                            </li>
        ...
        <div class="page-content d-flex align-items-stretch">
            ...
            <div class="content-inner w-100">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 pb-1 mt-5 offset-lg-1">
                        <div class="product-item bg-light mb-4">
                            <div class="product-img position-relative overflow-hidden cus">
                                <div class="row">
                                    <img class="img-fluid mt-5 col-12 offset-lg-1 col-lg-10" src="coconut.jpg" alt="">
                                </div>

                            </div>

                            <div class="text-center py-4">
                                <span class="card-text text-dark" style="font-size: 20px"><b> {{$home->diseases_name}} </b></span><br/>
                                <span class="mt-1">{{$home->time}}</span> <br />
                                <div class="d-flex align-items-center justify-content-center mb-1">
                                    <button class="col-3 btn btn-primary mt-1" onclick="sendID(<?php echo $home->id ?>);">Solution</button>
                                </div>
                            </div>
                        </div>
                    </div>
